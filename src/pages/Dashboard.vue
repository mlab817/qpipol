        ...
        <q-card>
          ...
          >
            <q-carousel-slide :name="1" class="q-pa-none">
              <q-scroll-area class="fit">
                <q-card flat class="my-card">
                  <img height="250px" :src="require('src/statics/undraw/undraw_detailed_analysis_xn7y.svg')">

                  <q-card-section>
                    <div class="text-h6">Do a detailed analysis of the PIP</div>
                  </q-card-section>
            ...
            <q-carousel-slide :name="2" class="q-pa-none">
              <q-scroll-area class="fit">
                <q-card flat class="my-card">
                  <img height="250px" :src="require('src/statics/undraw/undraw_noted_pc9f.svg')">
            ...
            <q-carousel-slide :name="3" class="q-pa-none">
              <q-scroll-area class="fit">
                <q-card flat class="my-card">
                  <img height="250px" :src="require('src/statics/undraw/undraw_success_factors_fay0.svg')">
